...
public class fun10_SettlePayServlet extends HttpServlet {
			...
			throws ServletException, IOException 
{
		...
		try {
		  ...
		  //  String id = ""+Calendar.getInstance().getTimeInMillis()+ Thread.currentThread().getId();
			...
			ses.setAttribute("settlepay_info", result);
		...
		req.getRequestDispatcher("fun10_settlepay.jsp").forward(req, resp);
