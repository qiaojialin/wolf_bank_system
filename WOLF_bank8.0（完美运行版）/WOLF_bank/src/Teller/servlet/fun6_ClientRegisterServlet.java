...
public class fun6_ClientRegisterServlet extends HttpServlet {
			...
			throws ServletException, IOException 
{
		...
		try {
            ...
            if(result.equals("success"))
            	ses.setAttribute("clientid", id);
			ses.setAttribute("clientregister_info", result);
		...
		req.getRequestDispatcher("fun6_clientregister.jsp").forward(req, resp);
