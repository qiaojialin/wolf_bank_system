...
public class fun12_LoanReceiptServlet extends HttpServlet {
			...
			throws ServletException, IOException 
{
		...
		try {
            ...
            req.setAttribute("loanreceipt_info", result);
		...
		req.getRequestDispatcher("fun12_loanreceipt.jsp").forward(req, resp);
	}
