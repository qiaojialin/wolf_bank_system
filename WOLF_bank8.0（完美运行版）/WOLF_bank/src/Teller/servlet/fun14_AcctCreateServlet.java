...
public class fun14_AcctCreateServlet extends HttpServlet {
			...
			throws ServletException, IOException 
{
		...
		try {
		  ...
		  //  String id = ""+Calendar.getInstance().getTimeInMillis()+ Thread.currentThread().getId();
            ...
            if(result.equals("failure"))
            	ses.setAttribute("acctcreate_info", "客户不存在");
            else
            	ses.setAttribute("acctcreate_info", result);
		...
		req.getRequestDispatcher("fun14_acctcreate.jsp").forward(req, resp);
