...
public class fun9_DrawdownServlet extends HttpServlet {
			...
			throws ServletException, IOException 
{
		...
		try {
		  ...
		  //  String id = ""+Calendar.getInstance().getTimeInMillis()+ Thread.currentThread().getId();
			...
			ses.setAttribute("drawdown_info", result);
		...
		req.getRequestDispatcher("fun9_drawdown.jsp").forward(req, resp);
